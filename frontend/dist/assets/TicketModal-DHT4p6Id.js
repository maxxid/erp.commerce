import{k as a,h as u,c as l,d as t,f as x,q as g,t as n,F as h,m as w,g as r,v as y,K as k,j as p}from"./index-Xw10vksL.js";const v={class:"bg-white rounded-2xl shadow-2xl max-w-sm w-full max-h-[90vh] overflow-y-auto"},j={class:"flex items-center justify-between p-4 border-b border-slate-100"},_={class:"flex items-center gap-2"},T={class:"text-center border-b-2 border-slate-900 pb-2 mb-2"},C={class:"text-[9px] text-slate-500"},z={class:"text-[9px] text-slate-400"},$={class:"font-bold text-sm mt-1"},F={class:"space-y-0.5 mb-2"},N={class:"flex-1 truncate"},S={key:0,class:"text-[9px] text-orange-600 font-bold"},B={class:"w-10 text-right"},E={class:"w-20 text-right font-mono-data"},O={class:"w-20 text-right font-bold"},P={class:"border-t border-slate-300 pt-1 space-y-0.5"},D={key:0,class:"flex justify-between text-[10px]"},I={class:"font-bold"},L={class:"flex justify-between text-sm font-bold"},M={class:"border-t border-dotted border-slate-300 mt-2 pt-1 text-[10px] space-y-0.5"},V={class:"flex justify-between"},A={class:"font-bold capitalize"},W={key:0,class:"flex justify-between"},K={class:"font-bold"},R={key:0,class:"border-t border-dotted border-slate-300 mt-2 pt-1 text-[9px] space-y-0.5"},q={class:"flex justify-between"},G={class:"font-bold"},H={class:"text-center text-[8px] text-slate-400 mt-3 pt-2 border-t border-slate-200"},U={__name:"TicketModal",props:{show:Boolean,ticket:{type:Object,default:()=>({items:[]})}},emits:["close"],setup(o){const d=p(()=>{try{const i=JSON.parse(localStorage.getItem("apex_lookup_settings"));return(i==null?void 0:i.ticketWidth)||80}catch{return 80}}),m=p(()=>({width:"100%",maxWidth:d.value+"mm",margin:"0 auto",fontFamily:"'Courier New', monospace"}));function c(i){return i==null?"$0":"$"+Number(i).toLocaleString("es-AR",{minimumFractionDigits:2})}function b(){const i=document.getElementById("thermal-ticket");if(!i)return;const e=window.open("","_blank","width=300,height=600");e.document.write(`
